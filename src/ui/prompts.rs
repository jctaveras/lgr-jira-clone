use crate::{model::{Epic, Story, ItemStatus, ItemDetail, ItemId}, io_utils::get_user_input};
...
fn create_story_prompt() -> Story {
    ...
    return Story::new(ItemDetail { description, id: ItemId(0), name, status: ItemStatus::Open })
}
